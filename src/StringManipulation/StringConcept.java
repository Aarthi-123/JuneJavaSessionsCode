...
public class StringConcept {
	...
	public static void main(String[] args) {
		...
		System.out.println(str.charAt(str.length()-1));//highest index of character will display
		...
		System.out.println(str.indexOf("ruby"));//o/p : -1
		...
		System.out.println(s.trim());//trim will remove the corner space oly
		...
		System.out.println(t.replace(" ", ""));//it will remove the in b/w space using replace 
		...
		//String comp:
				...
				//System.out.println(m1 == m2);//u should not use == for comparison... always use .equals for string
				
				//
				String main = "welcome to     testing     world testing naveen testing";
				System.out.println(main.contains("testing"));
				
				System.out.println(main.replaceAll("\\s+", " "));// "\\s+---multiple space
